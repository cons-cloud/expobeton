-- Script de mise à jour de la structure des contacts - VERSION CORRIGÉE
...
-- 4. Mettre à jour les contacts existants pour utiliser la nouvelle structure
UPDATE contacts 
SET 
  nom = CASE 
...
SELECT 
  ...
  'email | nom | prenom | societe | telephone' as format
...
SELECT 
  ...
  'Seuls email et societe seront utilises pour la synchronisation' as note;
...
SELECT '=== STRUCTURE DES CONTACTS MISE A JOUR ===' as info;
...
SELECT 
  'Etape 1' as etape,
  'Preparer fichier Excel avec colonnes: email, nom, prenom, societe, telephone' as instruction
...
SELECT 
  'Etape 3' as etape,
  'Seuls email et societe seront utilises pour les envois' as instruction;

SELECT '=== MISE A JOUR TERMINEE ===' as info;
