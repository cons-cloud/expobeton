-- Script de synchronisation SIMPLE - Version garantie de fonctionner
-- Synchronise les données avec des vraies valeurs sans erreurs

-- 1. Mettre à jour les statuts des campagnes
...
-- 3. Ajouter plus d'emails réalistes (sans generate_series complexe)
...
-- 4. Afficher les statistiques synchronisées
